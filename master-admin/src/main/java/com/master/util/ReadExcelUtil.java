...
/**
 * 描 述：Excel文件操作工具类，包括读、写、合并等功能 创建时间：2016-7-27
 * 
 * @author Jibaole
 */
public class ReadExcelUtil {
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i < rowList.size(); i++) {
			...
			System.out.println("" + getCellValue(obj.getCell(0)) + "|" + getCellValue(obj.getCell(1)) + "|"
					+ getCellValue(obj.getCell(2)) + "|" + getCellValue(obj.getCell(3)) + "|"
					+ getCellValue(obj.getCell(4)));
		}
